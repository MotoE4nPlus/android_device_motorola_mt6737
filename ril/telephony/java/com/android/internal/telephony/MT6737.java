 ...
 * {@hide}
 */
public class MT6737 extends RIL implements CommandsInterface {
    ...
    public MT6737(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
        //mContext = context;
        Rlog.i("MT6737", "Ctor1: context is " + mContext);
        mTelephonyManager = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        mEccList = new MtkEccList();
    }

    public MT6737(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        super(context, preferredNetworkType, cdmaSubscription, instanceId);
        //mContext = context;
        Rlog.i("MT6737", "Ctor2: context is " + mContext);
        mTelephonyManager = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        mEccList = new MtkEccList();
    }
    ...
    iccIOForApp (int command, int fileid, String path, int p1, int p2, int p3,
        ...
        if (command == 0xc0 && p3 == 0) {
            Rlog.i("MT6737", "Override the size for the COMMAND_GET_RESPONSE 0 => 15");
            p3 = 15;
        }
